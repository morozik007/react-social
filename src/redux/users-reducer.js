...
export const setUsers = (users) => ({ type: SET_USERS, users }) ; // экшн для юзеров с сервера
export const setCurrentPage = (currentPage) => ({ type: SET_CURRENT_PAGE, currentPage /*currentPage: currentPage*/ }) ;
